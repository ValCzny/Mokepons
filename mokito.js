...
let xayahEnemigo = new Mokepon("Xayah", 'xayah.png', 5, 'xayah.png')

let akaliEnemigo = new Mokepon("Akali", 'akali.png', 5, 'akali.png')

let caitlynEnemigo = new Mokepon("Caitlyn", 'cait.png', 5, 'cait.png')
...
function seleccionarCampeonEnemigo(enemigo){
  //let campeonAleatoria = aleatorio(0, mokepones.length -1)
  
  spanCampeonEnemigo.innerHTML = enemigo.nombre
  ataquesCampeonEnemigo = enemigo.ataques
  secuenciaAtaque()
}
...
function pintarCanvas(){
  ...
  if(campeonJugadorObjeto.velocidadX !== 0 || campeonJugadorObjeto.velocidadY !== 0){
    ...
    revisarColision(akaliEnemigo)
    revisarColision(caitlynEnemigo)
  }
}
...
function revisarColision(enemigo){ 
  ...
  sectionVerMapa.style.display = "none"
  seleccionarCampeonEnemigo(enemigo)
